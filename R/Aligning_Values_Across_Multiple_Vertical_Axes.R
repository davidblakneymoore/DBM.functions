...
#'
#' # Generate some made-up data and we'll align zeroes across the vertical axes.
#' set.seed(100)
#' # Made_Up_Data_for_the_Aligning_Values_Across_Multiple_Vertical_Axes_Function <- data.frame(Index = seq_len(100), Variable_1 = rnorm(100, -1, 1), Variable_2 = rnorm(100, 0, 1), Variable_3 = rnorm(100, 1, 1))
...
#' par(mar = c(6, 6, 6, 12))
#' plot(Variable_1 ~ Index, data = Made_Up_Data_for_the_Aligning_Values_Across_Multiple_Vertical_Axes_Function, xlab = "", ylab = "", yaxt = "n", pch = 19, main = "All Variables on One Plot (Values not Aligned)", col = 2, cex.main = 1.5)
...
#' plot(Variable_1 ~ Index, data = Made_Up_Data_for_the_Aligning_Values_Across_Multiple_Vertical_Axes_Function, xlab = "", ylab = "", yaxt = "n", ylim = Final_Vertical_Axis_Limits[[1]], col = 2, pch = 19, main = "All Variables on One Plot (Values Aligned)", cex.main = 1.5)
...
#' legend("top", xpd = TRUE, inset = c(0, -0.3), title = expression(paste(bold("Variable"))), legend = 1:3, col = 2:4, pch = 19, horiz = T, cex = 1.25)
#'
