...
#' 
#' @examples
#' Values_to_Align = c(-2, 0, 0) # These are the values that will align on our graph.
#' Variable_Weights <- c(0.75, 0.125, 0.125) # Weigh the first variable more heavily than the other two.
#' (Final_Vertical_Axis_Limits <- Aligning_Values_Across_Multiple_Vertical_Axes(Variable_1, Variable_2, Variable_3, Data_Frame = DBM.functions::Made_Up_Data_for_the_Aligning_Values_Across_Multiple_Vertical_Axes_Function, Values_to_Align = Values_to_Align, Variable_Weights = Variable_Weights))
#' layout(matrix(c(1, 1, 2, 2, 3, 3, 4, 4, 4, 5, 5, 5), ncol = 6, byrow = TRUE), heights = c((1 / 3), (2 / 3)))
#' par(mar = c(6, 5, 5, 3))
#' plot(Variable_1 ~ Index, data = DBM.functions::Made_Up_Data_for_the_Aligning_Values_Across_Multiple_Vertical_Axes_Function, xlab = "", ylab = "", main = "Variable 1", pch = 20)
#' mtext("Index", 1, line = 2.5)
#' mtext("Variable 1", 2, line = 2.5)
#' plot(Variable_2 ~ Index, data = DBM.functions::Made_Up_Data_for_the_Aligning_Values_Across_Multiple_Vertical_Axes_Function, xlab = "", ylab = "", main = "Variable 2", pch = 20, col = 2)
#' mtext("Index", 1, line = 2.5)
#' mtext("Variable 2", 2, line = 2.5)
#' plot(Variable_3 ~ Index, data = DBM.functions::Made_Up_Data_for_the_Aligning_Values_Across_Multiple_Vertical_Axes_Function, xlab = "", ylab = "", main = "Variable 3", pch = 20, col = 3)
#' mtext("Index", 1, line = 2.5)
#' mtext("Variable 3", 2, line = 2.5)
#' par(mar = c(12, 6, 6, 12))
#' plot(Variable_1 ~ Index, data = DBM.functions::Made_Up_Data_for_the_Aligning_Values_Across_Multiple_Vertical_Axes_Function, xlab = "", ylab = "", yaxt = "n", pch = 20, main = "Multiple Vertical Axes With Values Not Aligned")
#' axis(2, at = pretty(DBM.functions::Made_Up_Data_for_the_Aligning_Values_Across_Multiple_Vertical_Axes_Function$Variable_1))
#' mtext("Index", 1, line = 2.5)
#' mtext("Variable 1", 2, line = 2.5)
#' par(new = T)
#' plot(Variable_2 ~ Index, data = DBM.functions::Made_Up_Data_for_the_Aligning_Values_Across_Multiple_Vertical_Axes_Function, xlab = "", ylab = "", yaxt = "n", col = 2, pch = 20)
#' axis(4, at = pretty(DBM.functions::Made_Up_Data_for_the_Aligning_Values_Across_Multiple_Vertical_Axes_Function$Variable_2))
#' mtext("Variable 2", 4, line = 2.5)
#' par(new = T)
#' plot(Variable_3 ~ Index, data = DBM.functions::Made_Up_Data_for_the_Aligning_Values_Across_Multiple_Vertical_Axes_Function, xlab = "", ylab = "", yaxt = "n", col = 3, pch = 20)
#' axis(4, at = pretty(DBM.functions::Made_Up_Data_for_the_Aligning_Values_Across_Multiple_Vertical_Axes_Function$Variable_3), line = 5)
...
#' plot(Variable_1 ~ Index, data = DBM.functions::Made_Up_Data_for_the_Aligning_Values_Across_Multiple_Vertical_Axes_Function, xlab = "", ylab = "", yaxt = "n", ylim = Final_Vertical_Axis_Limits[[1]], pch = 20, main = "Multiple Vertical Axes With Values Aligned")
#' axis(2, at = pretty(range(Final_Vertical_Axis_Limits[[1]])))
#' mtext("Index", 1, line = 2.5)
#' mtext("Variable 1", 2, line = 2.5)
#' abline(h = Values_to_Align[1], lty = 2)
#' par(new = T)
#' plot(Variable_2 ~ Index, data = DBM.functions::Made_Up_Data_for_the_Aligning_Values_Across_Multiple_Vertical_Axes_Function, xlab = "", ylab = "", yaxt = "n", ylim = Final_Vertical_Axis_Limits[[2]], col = 2, pch = 20)
#' axis(4, at = pretty(range(Final_Vertical_Axis_Limits[[2]])))
#' mtext("Variable 2", 4, line = 2.5)
#' abline(h = Values_to_Align[2], lty = 2)
#' par(new = T)
#' plot(Variable_3 ~ Index, data = DBM.functions::Made_Up_Data_for_the_Aligning_Values_Across_Multiple_Vertical_Axes_Function, xlab = "", ylab = "", yaxt = "n", ylim = Final_Vertical_Axis_Limits[[3]], col = 3, pch = 20)
