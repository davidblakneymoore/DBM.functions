#' Generating Figures Containing a Bipartite Interaction Matrix Visualization Plot and Corresponding Upper and Lower Trophic Level Phenology Plots
#'
...
#'   x
#' })
#' Lower_Trophic_Level_Species_Names_Data_Frame_1 <- data.frame(Row_Name = paste("Species", letters[seq_len(4)]), Names_for_Plotting = c("expression(paste(italic('Lotus corniculatus')))", "expression(paste(italic('Medicago sativa')))", "expression(paste(italic('Pisum'), ' sp.'))", "expression(paste(italic('Trifolium'), ' spp.'))"))
...
#'
#' # Example Figure 1
#' Generating_Figures_Containing_a_Bipartite_Interaction_Matrix_Visualization_Plot_and_Corresponding_Upper_and_Lower_Trophic_Level_Phenology_Plots(List_of_Bipartite_Interaction_Matrices_by_Date_1, Include_Scale_Bars = FALSE)
#'
#' # Example Figure 2
...
#'
#' # Example Figure 3
#' Generating_Figures_Containing_a_Bipartite_Interaction_Matrix_Visualization_Plot_and_Corresponding_Upper_and_Lower_Trophic_Level_Phenology_Plots(List_of_Bipartite_Interaction_Matrices_by_Date_2, Scale_Bar_Factor = (1 / 3), Column_of_Already_Pooled_Species_Name = "Miscellaneous Species", Species_Name_Font_Size = 1.25)
#'
#' # Example Figure 4
#' Generating_Figures_Containing_a_Bipartite_Interaction_Matrix_Visualization_Plot_and_Corresponding_Upper_and_Lower_Trophic_Level_Phenology_Plots(List_of_Bipartite_Interaction_Matrices_by_Date_1, Scale_Bar_Factor = (1 / 3), Lower_Trophic_Level_Species_Names_Data_Frame = Lower_Trophic_Level_Species_Names_Data_Frame_1, Higher_Trophic_Level_Species_Names_Data_Frame = Higher_Trophic_Level_Species_Names_Data_Frame_1, Overall_Plot_Title = "Example Figure 4", Lower_Trophic_Level_Plot_Title = "Plants", Higher_Trophic_Level_Plot_Title = "Pollinators")
#'
#' @export
Generating_Figures_Containing_a_Bipartite_Interaction_Matrix_Visualization_Plot_and_Corresponding_Upper_and_Lower_Trophic_Level_Phenology_Plots <- function (List_of_Bipartite_Interaction_Matrices_by_Date, Overall_Plot_Title = NULL, Lower_Trophic_Level_Plot_Title = "Lower Trophic Level", Higher_Trophic_Level_Plot_Title = "Higher Trophic Level", Prioritize_Interaction_Strength_Over_Alphabetization_in_Species_Layout = FALSE, Lower_Trophic_Level_Color = "darkgreen", Higher_Trophic_Level_Color = "darkred", Interaction_Color = "black", How_to_Treat_Missing_Values = "Remove the Columns", Include_Scale_Bars = TRUE, Scale_Bar_Factor = (1 / 3), Approximate_Proportion_of_Lower_Trophic_Level_Species_to_Pool = 0, Approximate_Proportion_of_Higher_Trophic_Level_Species_to_Pool = 0, Lower_Trophic_Level_Species_Names_Data_Frame = NULL, Higher_Trophic_Level_Species_Names_Data_Frame = NULL, Relative_Plot_Widths = c(11, 4, 10, 4, 11), Relative_Plot_Heights = c(rep(1, ifelse(is.null(Overall_Plot_Title), 1, 2)), ifelse(is.null(Overall_Plot_Title), 9, 8)), Row_of_Already_Pooled_Species_Name = NULL, Column_of_Already_Pooled_Species_Name = NULL, Gap_Size_Constant = 0.2, Relative_Bar_Width = 0.2, Horizontal_Scale_Text_Shift_Constant = 0.1, Vertical_Scale_Title_Shift_Constant = 0.1, Scale_Bar_Title_Font_Size = 1, Scale_Bar_Text_Font_Size = 1, Overall_Plot_Title_Font_Size = 3.25, Trophic_Level_Plot_Title_Font_Size = 2.5, Phenology_and_Bipartite_Plot_Title_Font_Size = 1.5, Species_Name_Font_Size = 1.5, Horizontal_Axis_Title_Font_Size = 1, Horizontal_Axis_Dates_Font_Size = 1, Left_and_Right_Figure_Margins = 9, Between_Title_Plots_and_Other_Plots_Margin = 1, Bottom_Margin = 8) {
  ...
  if (!is.null(Lower_Trophic_Level_Species_Names_Data_Frame)) {
    ...
    if (!("Row_Name" %in% colnames(Lower_Trophic_Level_Species_Names_Data_Frame))) {
      stop ("The 'Lower_Trophic_Level_Species_Names_Data_Frame' data frame must contain a column named 'Row_Name' whose entries must identically match the names of the rows of the matrices (which represent the lower-trophic-level species).")
    }
    if (!("Names_for_Plotting" %in% colnames(Lower_Trophic_Level_Species_Names_Data_Frame))) {
      stop ("The 'Lower_Trophic_Level_Species_Names_Data_Frame' data frame must contain a column named 'Names_for_Plotting' whose entries will appear as the (potentially stylized) lower-trophic-level species names in the resulting figure.")
    }
  }
