...
#'
#' `Finding_the_Optimal_Sigmoid_Function_Model` determines which sigmoid model best fits a binary response data set (a data set where the response variable contains only `1`s and `0`s).
#' 
