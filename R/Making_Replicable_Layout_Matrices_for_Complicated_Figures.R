...
#'
#' This function relies on the \link[DBM.functions]{Checking_Layout_Matrix_Viability} function, which is also found in the `DBM.functions` package.
#'
...
Making_Replicable_Layout_Matrices_for_Complicated_Figures <- function(Individual_Layout_Matrix, Overall_Layout_Matrix) {
  ...
  Individual_Layout_Matrix_Viability <- DBM.functions::Checking_Layout_Matrix_Viability(Individual_Layout_Matrix)
  Overall_Layout_Matrix_Viability <- DBM.functions::Checking_Layout_Matrix_Viability(Overall_Layout_Matrix)
  ...
  Individual_Layout_Matrix[which(Individual_Layout_Matrix == 0)] <- NA
  ...
  Final_Matrix[which(is.na(Final_Matrix))] <- 0
  Final_Matrix
}
