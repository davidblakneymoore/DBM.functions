...
#'
#' @export
Generating_Axis_Limits_for_Figures_With_Text_Function <- function (Points_Horizontal_Axis_Coordinates, Points_Vertical_Axis_Coordinates, Texts, Texts_Horizontal_Axis_Coordinates, Texts_Vertical_Axis_Coordinates, Character_Expansion = 1, Vertical_Text_Spacing_Constant = 1) {
