...
#' This function w
#'
#' `Regression_for_Repeated_Measures_Designs_When_Predictor_Variables_Are_Bins_of_Numbers_and_Bins_Are_Continuous` w
#' @param Treatment w
#' @param Replicate w
...
#' @param Beta_Distribution_Parameter_Rounding_Constant w
#' @param Number_of_Bins_in_the_Figure_4_Histograms w
#' @param Maximum_Number_of_Iterations w
#' @param Estimate_Beta_Distribution_Parameters w
...
#' @param Beta_Distribution_Curve_Resolution w
#'
...
Regression_for_Repeated_Measures_Designs_When_Predictor_Variables_Are_Bins_of_Numbers_and_Bins_Are_Continuous <- function (Treatment, Replicate, Predictor_Variable, Predictor_Variable_Bin_Lower_Limits, Predictor_Variable_Bin_Upper_Limits, Response_Variable, Beta_Distribution_Alpha_Parameter_Values, Beta_Distribution_Beta_Parameter_Values, Data_Frame, Parameters, Formula, Color_Data, Color_Opacity = 0.5, Number_of_Simulations_per_Experimental_Unit = 1000, Number_of_Histogram_Bins = 100, Moments_to_Report = 4, Make_Figure_1 = T, Make_Figure_2 = T, Make_Figure_3 = T, Make_Figure_4 = T, Working_Directory = getwd(), First_Figure_Name = "Figure 1", Second_Figure_Name = "Figure 2", Third_Figure_Name = "Figure 3", Fourth_Figure_Name = "Figure 4", Show_Individual_Plot_Titles = F, Show_Moments_in_Figure_1 = T, Show_Overlapping_Areas_in_Figure_2 = T, Show_Moments_in_Figure_3 = T, Show_Moments_in_Figure_4 = T, Moment_Rounding_Constant = 3, Overlapping_Area_Rounding_Constant = 3, Beta_Distribution_Parameter_Rounding_Constant = 3, Number_of_Bins_in_the_Figure_4_Histograms = 10, Maximum_Number_of_Iterations = 1000, Estimate_Beta_Distribution_Parameters = F, Relative_Figure_1_Parameter_Plot_Height = 4, Relative_Figure_1_Treatment_Plot_Height = 3, Relative_Figure_1_Replicate_Plot_Height = 2, Relative_Figure_1_Individual_Plot_Height = 10, Relative_Figure_1_Legend_Plot_Height = 4, Relative_Figure_1_Individual_Plot_Width = 5, Relative_Figure_1_Gap_Plot_Width = 1, Relative_Figure_1_Parameter_Spacing_Line_Plot_Height = 1, Figure_1_Figure_Height_Constant = 30, Figure_1_Figure_Width_Constant = 45, Figure_1_Axis_Labels_and_Axis_Titles_Shifting_Constant = 0, Figure_1_Parameter_Title_Text_Size = 4, Figure_1_Treatment_Title_Text_Size = 3, Figure_1_Replicate_Title_Text_Size = 2, Figure_1_Axis_Titles_Text_Size = 2, Figure_1_Axis_Labels_Text_Size = 2, Figure_1_Individual_Plot_Bottom_Margin = 5, Figure_1_Individual_Plot_Left_Margin = 5, Figure_1_Individual_Plot_Top_Margin = 1, Figure_1_Individual_Plot_Right_Margin = 1, Figure_1_Moment_Text_Size = 2, Figure_1_Legend_Text_Size = 3, Figure_1_Panel_Separation_Line_Width = 2, Relative_Figure_2_Parameter_Plot_Height = 4, Relative_Figure_2_Treatment_Plot_Height = 3, Relative_Figure_2_Replicate_Plot_Height = 2, Relative_Figure_2_Individual_Plot_Dimension = 10, Relative_Figure_2_Gap_Plot_Dimension = 2, Relative_Figure_2_Legend_Plot_Height = 8, Relative_Figure_2_Parameter_Spacing_Line_Plot_Height = 1, Figure_2_Figure_Height_Constant = 75, Figure_2_Figure_Width_Constant = 100, Figure_2_Axis_Labels_and_Axis_Titles_Shifting_Constant = 1, Figure_2_Parameter_Title_Text_Size = 10, Figure_2_Treatment_Title_Text_Size = 8, Figure_2_Replicate_Title_Text_Size = 6, Figure_2_Axis_Titles_Text_Size = 2.5, Figure_2_Axis_Labels_Text_Size = 2.5, Figure_2_Individual_Plot_Bottom_Margin = 10, Figure_2_Individual_Plot_Left_Margin = 10, Figure_2_Individual_Plot_Top_Margin = 1, Figure_2_Individual_Plot_Right_Margin = 1, Figure_2_Overlapping_Area_Text_Size = 4, Figure_2_Legend_Text_Size = 3.5, Figure_2_Panel_Separation_Line_Width = 2, Relative_Figure_3_Parameter_Plot_Height = 4, Relative_Figure_3_Treatment_Plot_Dimension = 3, Relative_Figure_3_Replicate_Plot_Dimension = 2, Relative_Figure_3_Individual_Plot_Dimension = 10, Relative_Figure_3_Gap_Plot_Dimension = 2, Relative_Figure_3_Legend_Plot_Height = 4, Relative_Figure_3_Parameter_Spacing_Line_Plot_Height = 1, Figure_3_Figure_Height_Constant = 60, Figure_3_Figure_Width_Constant = 75, Figure_3_Axis_Labels_and_Axis_Titles_Shifting_Constant = 1, Figure_3_Parameter_Title_Text_Size = 10, Figure_3_Treatment_Title_Text_Size = 8, Figure_3_Replicate_Title_Text_Size = 6, Figure_3_Axis_Titles_Text_Size = 4, Figure_3_Axis_Labels_Text_Size = 4, Figure_3_Individual_Plot_Bottom_Margin = 10, Figure_3_Individual_Plot_Left_Margin = 10, Figure_3_Individual_Plot_Top_Margin = 1, Figure_3_Individual_Plot_Right_Margin = 1, Figure_3_Moment_Text_Size = 4, Figure_3_Legend_Text_Size = 3.5, Figure_3_Panel_Separation_Line_Width = 2, Relative_Figure_4_Parameter_Plot_Height = 2, 
  ...
  if (!is.numeric(Predictor_Variable_Bin_Lower_Limits)) {
    stop ("The 'Predictor_Variable_Bin_Lower_Limits' argument must be numeric.")
  }
  ...
  if (!is.numeric(Predictor_Variable_Bin_Upper_Limits)) {
    stop ("The 'Predictor_Variable_Bin_Upper_Limits' argument must be numeric.")
  }
  ...
  Diagnostic_Data_Frame <- do.call("rbind", lapply(Split_Data, function (x) {
    do.call("rbind", lapply(x, function (y) {
      z <- data.frame(Treatment = unique(y[, which(colnames(y) == Treatment_Name)]), Replicate = unique(y[, which(colnames(y) == Replicate_Name)]), Are_There_Enough_Response_Variable_Entries = !(length(which(is.finite(y[, which(colnames(y) == Response_Variable_Name)]))) <= length(Parameters)), Are_There_Enough_Predictor_Variable_Bin_Lower_Limits_Entries = !(length(which(is.finite(y[, which(colnames(y) == Predictor_Variable_Bin_Lower_Limits_Name)]))) <= length(Parameters)), Are_There_Enough_Predictor_Variable_Bin_Upper_Limits_Entries = !(length(which(is.finite(y[, which(colnames(y) == Predictor_Variable_Bin_Upper_Limits_Name)]))) <= length(Parameters)))
  ...
  if (length(Estimate_Beta_Distribution_Parameters) != 1) {
    stop ("The 'Estimate_Beta_Distribution_Parameters' argument must be of length 1.")
  }
  if (!is.logical(Estimate_Beta_Distribution_Parameters)) {
    stop ("The 'Estimate_Beta_Distribution_Parameters' argument must be of class 'logical'.")
  }
  if (is.na(Estimate_Beta_Distribution_Parameters)) {
    stop ("The 'Estimate_Beta_Distribution_Parameters' argument must not be missing.")
  }
  if (Make_Figure_4 == T) {
    ...
    if (Show_Moments_in_Figure_4 == T) {
      ...
      if (Estimate_Beta_Distribution_Parameters == T) {
        if (length(Beta_Distribution_Parameter_Rounding_Constant) != 1) {
          stop ("The 'Beta_Distribution_Parameter_Rounding_Constant' argument must be of length 1.")
        }
        if (!is.numeric(Beta_Distribution_Parameter_Rounding_Constant)) {
          stop ("The 'Beta_Distribution_Parameter_Rounding_Constant' argument must be of class 'numeric'.")
        }
        if (is.na(Beta_Distribution_Parameter_Rounding_Constant)) {
          stop ("The 'Beta_Distribution_Parameter_Rounding_Constant' argument must not be missing.")
        }
        if (Beta_Distribution_Parameter_Rounding_Constant < 0) {
          stop ("The 'Beta_Distribution_Parameter_Rounding_Constant' argument must not be negative.")
        }
        if ((Beta_Distribution_Parameter_Rounding_Constant %% 1) != 0) {
          stop ("The 'Beta_Distribution_Parameter_Rounding_Constant' argument must not be negative.")
        }
        if (length(Beta_Distribution_Curve_Resolution) != 1) {
          stop ("The 'Beta_Distribution_Curve_Resolution' argument must be of length 1.")
        }
        if (is.na(Beta_Distribution_Curve_Resolution)) {
          stop ("The 'Beta_Distribution_Curve_Resolution' argument must not be missing.")
        }
        if (!is.numeric(Beta_Distribution_Curve_Resolution)) {
          stop ("The 'Beta_Distribution_Curve_Resolution' argument must be numeric.")
        }
        if ((Beta_Distribution_Curve_Resolution <= 0) | (Beta_Distribution_Curve_Resolution >= 10)) {
          stop ("The 'Beta_Distribution_Curve_Resolution' argument must be a number between 0 and 10 (exclusive).")
        }
      }
    ...
    lapply(w, function (x) {
      z <- as.data.frame(lapply(x, function (y) {
        sapply(seq_len(Number_of_Simulations_per_Experimental_Unit), function (i) {
          rbeta(1, y[, which(colnames(y) == Beta_Distribution_Alpha_Parameter_Values_Name)], y[, which(colnames(y) == Beta_Distribution_Beta_Parameter_Values_Name)]) * (y[, which(colnames(y) == Predictor_Variable_Bin_Upper_Limits_Name)] - y[, which(colnames(y) == Predictor_Variable_Bin_Lower_Limits_Name)]) + y[, which(colnames(y) == Predictor_Variable_Bin_Lower_Limits_Name)]
        })
      }))
      colnames(z) <- apply(sapply(Split_Data, function (x) {
  ...
  #####
  if (Estimate_Beta_Distribution_Parameters == T) {
    Overlapping_Area_Beta_Distribution_Parameters <- lapply(Overlapping_Area_Moments, function (x) {
      lapply(x, function (y) {
        Alpha <- y$Mean * ((y$Mean * (1 - y$Mean) / y$Variance) - 1)
        Beta <- (1 - y$Mean) * ((y$Mean * (1 - y$Mean) / y$Variance) - 1)
  ...
  if (Make_Figure_4 == T) {
    ...
    Figure_4_Vertical_Axis_Stuff <- setNames(lapply(seq_along(Parameters), function (b) {
      lapply(seq_along(Overlapping_Areas_List[[b]]), function (i) {
        if (Show_Moments_in_Figure_4 == T) {
          ...
          } else if (Estimate_Beta_Distribution_Parameters == F) {
            DBM.functions::Adding_a_Text_Box_at_the_Top_of_a_Histogram(Overlapping_Areas_List[[b]][[i]], Text = paste(rep("\n", (Moments_to_Report - 1)), collapse = ""), Text_Size = Figure_4_Moment_Text_Size, Plot_Margins = c(Figure_4_Individual_Plot_Bottom_Margin, Figure_4_Individual_Plot_Left_Margin, Figure_4_Individual_Plot_Top_Margin, Figure_4_Individual_Plot_Right_Margin), xlim = Figure_4_Plotting_Information[[b]]$Horizontal_Axis_Limits, breaks = Figure_4_Plotting_Information[[b]]$Breaks, freq = F, Tolerance = Tolerance)
          }
        } else if (Show_Moments_in_Figure_4 == F) {
          if (Estimate_Beta_Distribution_Parameters == T) {
            DBM.functions::Adding_a_Text_Box_at_the_Top_of_a_Histogram(Overlapping_Areas_List[[b]][[i]], Text = "\n", Text_Size = Figure_4_Moment_Text_Size, Plot_Margins = c(Figure_4_Individual_Plot_Bottom_Margin, Figure_4_Individual_Plot_Left_Margin, Figure_4_Individual_Plot_Top_Margin, Figure_4_Individual_Plot_Right_Margin), xlim = Figure_4_Plotting_Information[[b]]$Horizontal_Axis_Limits, breaks = Figure_4_Plotting_Information[[b]]$Breaks, freq = F, Tolerance = Tolerance)
          } else if (Estimate_Beta_Distribution_Parameters == F) {
    ...
    if (Estimate_Beta_Distribution_Parameters == T) {
      Horizontal_Axis_Coordinates <- seq(0, 1, Beta_Distribution_Curve_Resolution)
    }
    lapply(seq_along(Parameters), function (b) {
      par(mar = c(1, 1, 1, 1))
      ...
      lapply(seq_along(Overlapping_Areas_List[[b]]), function (i) {
        ...
        if (Estimate_Beta_Distribution_Parameters == T) {
          lines(Horizontal_Axis_Coordinates, dbeta(Horizontal_Axis_Coordinates, Overlapping_Area_Beta_Distribution_Parameters[[b]][[i]]["Alpha"], Overlapping_Area_Beta_Distribution_Parameters[[b]][[i]]["Beta"]))
          Beta_Distribution_Parameters <- Overlapping_Area_Beta_Distribution_Parameters[[b]][[i]]
        }
        Moments <- unlist(Overlapping_Area_Moments[[b]][[i]])
        if (Show_Moments_in_Figure_4 == T) {
          if (Estimate_Beta_Distribution_Parameters == T) {
            text(0.5, Figure_4_Vertical_Axis_Stuff[[b]]$Text_Vertical_Coordinate, labels = paste(paste(paste0(names(Moments), ": ", ifelse(is.finite(Moments), as.character(round(Moments, Moment_Rounding_Constant)), "Undefined")), collapse = "\n"), paste(paste0(names(Beta_Distribution_Parameters), ": ", round(Beta_Distribution_Parameters, Beta_Distribution_Parameter_Rounding_Constant)), collapse = "\n"), sep = "\n"), cex = Figure_4_Moment_Text_Size)
          } else if (Estimate_Beta_Distribution_Parameters == F) {
          ...
          if (Estimate_Beta_Distribution_Parameters == T) {
            text(0.5, Figure_4_Vertical_Axis_Stuff[[b]]$Text_Vertical_Coordinate, labels = paste(paste0(names(Beta_Distribution_Parameters), ": ", round(Beta_Distribution_Parameters, Beta_Distribution_Parameter_Rounding_Constant)), collapse = "\n"), cex = Figure_4_Moment_Text_Size)
          }
        }
      })
      par(mar = c(1, 1, 1, 1), mgp = c(3, 1, 0))
  ...
  Overlapping_Area_Data_Frame_2 <- do.call("rbind", lapply(seq_along(Parameters), function (i) {
    do.call("rbind", lapply(seq_along(Overlapping_Areas_List[[i]]), function (j) {
      ...
      if (Estimate_Beta_Distribution_Parameters == T) {
        g <- cbind(Coefficient = Parameters[i], First_Treatment = Treatments[1], Second_Treatment = Treatments[2], Comparison = names(Overlapping_Areas_List[[i]])[j], as.data.frame(t(unlist(Overlapping_Area_Moments[[i]][[j]]))), t(Overlapping_Area_Beta_Distribution_Parameters[[i]][[j]]))
      } else if (Estimate_Beta_Distribution_Parameters == F) {
