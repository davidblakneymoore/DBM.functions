...
#'
#' This function relies on the \link[DBM.functions]{Finding_the_Full_Diagonal_of_a_Matrix} function and the \link[DBM.functions]{Generating_Permutations} function, which are both also from the `DBM.functions` package.
#'
