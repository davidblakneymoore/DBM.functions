...
#'
#' This function generates plot layout matrices that allow the user to break up extensive numbers of plots across multiple figures across multiple pages of a manuscript or multiple slides in a presentation.
#'
#' `Laying_Out_Plots_Across_Multiple_Pages_or_Slides` generates plot layout matrices that allow the user to break up extensive numbers of plots across multiple figures across multiple pages of a manuscript or multiple slides in a presentation.
#'
