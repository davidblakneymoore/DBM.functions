...
#' @param Variable_Weights the relative weights (importances) of each of the `...` arguments (variables) in the calculations. Variables that are weighed more heavily will be held more consistent across treatment groups than variables that are weighed less heavily.
#' @param Moment_Weighing_Method the method of weighing mathematical moments. Almost all of the default methods weigh lower-order moments more heavily than they weigh higher-order moments. This function calculates moments up to the order of the number of experimental units in each treatment group (as specified in the `Number_of_Experimental_Units_in_Each_Treatment_Group` argument).
...
#' @param Number_of_Combinations_to_Report the number of grouping assignments to report. Grouping assignments are always reported such that the best (most optimal) assignments are reported first.
#'
