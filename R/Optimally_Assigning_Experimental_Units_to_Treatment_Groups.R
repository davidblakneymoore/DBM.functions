#' Optimally Assigning Experimental Units to Treatment Groups
#'
...
#' @param Moment_Weighing_Method the method of weighing mathematical moments. Almost all of the default methods weigh lower-order moments more heavily than they weigh higher-order moments. This function calculates moments up to the order of the number of experimental units in each treatment group (as specified in the `Number_of_Experimental_Units_in_Each_Treatment_Group` argument). By default, each moment is weighed twice as heavily as the subsequent moment, with lower-order moments being weighed the most heavily and higher-order moments being weighed the least heavily.
...
#' (Optimal_Group_Assignments <- Optimally_Assigning_Experimental_Units_to_Treatment_Groups(Diameter_at_Breast_Height, Height, Crown_Class, Identifiers = Tree_Identifier, Data_Frame = Data_Frame, Number_of_Combinations_to_Report = 3, Number_of_Treatment_Groups = 3, Number_of_Experimental_Units_in_Each_Treatment_Group = 4))
#'
#' @export
