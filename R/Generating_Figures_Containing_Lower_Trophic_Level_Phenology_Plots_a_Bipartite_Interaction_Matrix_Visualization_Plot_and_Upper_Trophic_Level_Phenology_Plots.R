...
#'
#' # Example Figure 1
#' Generating_Figures_Containing_Lower_Trophic_Level_Phenology_Plots_a_Bipartite_Interaction_Matrix_Visualization_Plot_and_Upper_Trophic_Level_Phenology_Plots(List_of_Bipartite_Interaction_Matrices_by_Date_2, Scale_Bar_Factor = 0.25, Include_Scale_Bars = FALSE)
#'
#' # Example Figure 2
...
#'
#' @export
Generating_Figures_Containing_Lower_Trophic_Level_Phenology_Plots_a_Bipartite_Interaction_Matrix_Visualization_Plot_and_Upper_Trophic_Level_Phenology_Plots <- function (List_of_Bipartite_Interaction_Matrices_by_Date, Gap_Size_Constant = 0.2, Relative_Bar_Width = 0.2, Lower_Trophic_Level_Color = "darkgreen", Higher_Trophic_Level_Color = "darkred", Interaction_Color = "black", Scale_Bar_Tick_Length = 0.3, Horizontal_Scale_Text_Shift_Constant = 0.1, Vertical_Scale_Title_Shift_Constant = 0.1, Scale_Bar_Factor = 0.2, Relative_Plot_Widths = c(11, 4, 10, 4, 11), Relative_Plot_Heights = c(1, 9), Overall_Plot_Title_Font_Size = 3.25, Subplot_Title_Font_Size = 1.5, Species_Name_Font_Size = 1.5, Scale_Bar_Title_Font_Size = 1, Scale_Bar_Text_Font_Size = 1, Horizontal_Axis_Title_Font_Size = 1, Horizontal_Axis_Dates_Font_Size = 1, Left_and_Right_Figure_Margins = 9, Between_Title_Plots_and_Other_Plots_Margin = 1, Bottom_Margin = 8, Prioritize_Interaction_Strength_Over_Alphabetization_in_Species_Layout = FALSE, Include_Scale_Bars = TRUE) {
  ...
  if (!is.logical(Include_Scale_Bars)) {
    stop ("The 'Include_Scale_Bars' must be of class 'logical'.")
  }
  ...
  if (Include_Scale_Bars == TRUE) {
    Scale_Bar_Numbers <- DBM.functions::Making_Reasonable_Scale_Bars(Vertical_Axis_Limits)
  }
